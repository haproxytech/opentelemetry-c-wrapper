 ...
 */
  ...
  #define OTEL_EXPORTER_CASE_OSTREAM(arg_sig, arg_type, arg_ptr, arg_logfile)                                                               \
		...
		if (otel_exporter_set_ostream_options<arg_type>((arg_ptr)->ctx, OTEL_##arg_sig##_EXPORTER_DESC,                             \
		                                                ...
		                                                (arg_logfile), exporter_maybe, &((arg_ptr)->err), name) == OTELC_RET_ERROR) \
  ...
  #define OTEL_EXPORTER_CASE_OTLP_FILE(arg_sig, arg_base, arg_ptr)                                                \
		...
		if (otel_exporter_set_otlp_file_options((arg_ptr)->ctx, OTEL_##arg_sig##_EXPORTER_DESC,           \
		                                        OTEL_YAML_##arg_sig##_PREFIX OTEL_YAML_EXPORTERS,         \
		                                        options, rt_options, &((arg_ptr)->err), name) == OTELC_RET_ERROR) \
			OTELC_RETURN_INT(OTELC_RET_ERROR);                                                        \
...
/* <opentelemetry/exporters/otlp/otlp_grpc_client_options.h> */
  ...
  #define OTEL_EXPORTER_CASE_OTLP_GRPC(arg_sig, arg_base, arg_ptr)                                                               \
 ...
 */
  ...
  #define OTEL_EXPORTER_CASE_OTLP_HTTP(arg_sig, arg_base, arg_ptr)                                                                      \
