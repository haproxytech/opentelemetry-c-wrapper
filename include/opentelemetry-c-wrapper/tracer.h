...
struct otelc_tracer_ops {
	 ...
	 *   extract_http_headers, enabled, force_flush, or shutdown for the
	 *   same tracer when destroy runs, and the spans it produced must
	 *   already have been ended.  Destroy frees the underlying
