...
struct otelc_tracer_ops {
	 ...
	 *   span, or nullptr in case of an error or when the tracer is disabled.
	 */
	struct otelc_span *(*start_span)(struct otelc_tracer *tracer, const char *operation_name)
		OTELC_NONNULL_ALL;
	 ...
	 *   underlying SDK tracer would otherwise be enabled.  A tracer that has
	 *   not been started yet is reported as an error whatever the gate holds.
	 *
	 * RETURN VALUE
